if game.CoreGui:FindFirstChild("CoreGui") then
game.CoreGui:FindFirstChild("CoreGui"):Destroy()
end
...
-- // UI/GUI IS BIG, I WILL REWRITE IT SOON BUT THIS REMOTESPY WASN'T WRITTEN BY ME, SO IF YOU FACES PROBLEMS, DON'T CONTACT ME NGA. //
